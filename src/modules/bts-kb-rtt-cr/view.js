        ...
        this.service.getSPKByReference(this.data.code)
            .then(spk => {
              console.log(spk);
                ...
                this.printStruk += "    </tr>";
                this.printStruk += "    <tr style='height:20px;'>";
                this.printStruk += "        <td colspan='3' class='text-left' style='height:15px;'><b> Jln Merapi No. 23 Banaran, Grogol, Sukoharjo, Jawa Tengah, 57552 </b></td>";
                this.printStruk += "    </tr>";
                this.printStruk += "    <tr style='height:20px;'>";
                this.printStruk += "        <td colspan='3' class='text-left' style='height:15px;'><b> NPWP : 41.229.882.0-532.000 </b> </td>";
                this.printStruk += "    </tr>";
                this.printStruk += "    <tr style='height:20px;'>";
